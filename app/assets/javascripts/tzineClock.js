...
(function($){
	...
	var gVars = {};
    var timerVars = { hours: 0, minutes: 0, seconds: 0 }
    var globalCountdown = false;
	...
	$.fn.tzineClock = function(opts){
        ...
        // Custom code - set type of counter, and override time
        if ('hours' in opts) {
            timerVars['hours']   = opts["hours"];
        } else {
            timerVars['hours']   = 23;
        }

        if ('minutes' in opts) {
            timerVars['minutes'] = opts["minutes"];
        } else {
            timerVars['minutes'] = 59;
        }

        if ('seconds' in opts) {
            timerVars['seconds'] = opts["seconds"];
        } else {
